    ...
    return (
        <div className="mx-10 md:mx-0">
            <div className="h-full  align-middle inline py-auto">
                <div className="p-4 bg-blue-600 bg-opacity-50 max-w-[500px] mx-auto h-fit  my-40 rounded-lg">
                    <div className="p-4 bg-indigo-600 bg-opacity-50 max-w-[500px] mx-auto h-fit   rounded-lg">
                        <div className="bg-purple-600 rounded-lg p-8   mx-auto ">
                            <h2 className="text-gray-50 text-lg font-medium title-font mb-5">Sign Up</h2>
                            ...
                            <p className="text-xs text-gray-200 mt-3">Already Have An Account <Link href="/Login"><a className="border-b-2">Signup</a></Link></p>
                        </div>
                    </div>
                </div>
            </div>
...
const CreateUser = (user) => {
    ...
    return axios.post('https://polynotes-django-backend.herokuapp.com/auth/v1/Signup/',user)
}
